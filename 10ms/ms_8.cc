//% file: ms_8.cc
// merge sort with TBB tasks + parallel merge + DAG Recorder
// TBB task_group interface with DAG Recorder
//% cmd: g++ -DDAG_RECORDER=2 -DTO_TBB -I/home/tau/parallel2/sys/inst/g/include -L/home/tau/parallel2/sys/inst/g/lib -Wl,-R/home/tau/parallel2/sys/inst/g/lib -Wall -Wextra -std=gnu++11 -O3 -march=native ms_8.cc -o ms_8 -ldr -ltbb -lpthread
